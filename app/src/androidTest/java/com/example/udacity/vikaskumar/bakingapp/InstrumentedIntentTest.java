...
import com.example.udacity.vikaskumar.bakingapp.ui.RecipeDetailActivity;
...
@LargeTest
public class InstrumentedIntentTest {

    @Rule
    public IntentsTestRule<FoodItemActivity> mActivityTestRule = new IntentsTestRule<FoodItemActivity>(FoodItemActivity.class);
